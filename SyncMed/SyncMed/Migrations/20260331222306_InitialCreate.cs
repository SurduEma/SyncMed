        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DoctorLicenseId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NurseLicenseId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Nurses", x => x.NurseId);
                    table.ForeignKey(
                        name: "FK_Nurses_Users_NurseId",
                        column: x => x.NurseId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PatientId = table.Column<int>(type: "int", nullable: false),
                    DoctorId = table.Column<int>(type: "int", nullable: false),
                    DraftedByNurseId = table.Column<int>(type: "int", nullable: true),
                    MedicationDetails = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: false),
                    Status = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Prescriptions_Nurses_DraftedByNurseId",
                        column: x => x.DraftedByNurseId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TestResults_Doctors_UploadedByDoctorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Consultations_Nurses_NurseId",
                        column: x => x.NurseId,
                        principalTable: "Nurses",
                        principalColumn: "NurseId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Consultations_NurseId",
                table: "Consultations",
                column: "NurseId");

            migrationBuilder.CreateIndex(
                name: "IX_Doctors_DoctorLicenseId",
                table: "Doctors",
                column: "DoctorLicenseId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Nurses_NurseLicenseId",
                table: "Nurses",
                column: "NurseLicenseId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Prescriptions_DraftedByNurseId",
                table: "Prescriptions",
                column: "DraftedByNurseId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TestResults_UploadedByDoctorId",
                table: "TestResults",
